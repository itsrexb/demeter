	...
	<div class="contentwrap">
	   ...
	   <div class="row-fluid">	
			...
			<div class="col-md-8 col-md-offset-1">
			 ...
			 <div class="col-md-8 col-md-offset-1">
				<?php if(empty($data['freelancer'])){
					echo "Result empty!.";
				}else{ 
					foreach ($data['freelancer'] as $freelance) { ?>
								...
								<div style="color:#428bca;">
									<div><?php $avgstar = $this->fetch("SELECT avg(stars) as stars, count(*) as reviews 
										FROM `review_tb` where user_id='".$freelance['user_id']."'",true);
											...
											?> reviews</div>							
									<div style="margin-top:5px"><div class="label label-default">skills</div> <?php echo $freelance['meta_value'];?></div>
								</div>
